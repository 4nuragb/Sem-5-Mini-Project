    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><!--<img src="assets/images/logg.png" alt="image"/>--><i>Car Rental System</i></a> </div>
        </div>
...
<!-- <div class="login_btn"> <a href="./driver" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Driver Login</a> </div>  -->
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-testimonials.php">My Feedbacks</a></li>
            ...
            <!-- <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Profile Settings</a></li> -->
             ...
             <li><a href="./admin"  data-toggle="modal" data-dismiss="modal">Admin Login</a></li> 
             <li><a href="#forgotpassword"  data-toggle="modal" data-dismiss="modal">Change Password</a></li> 
