        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control white_bg" id="fullname" required autocomplete="off">
            </div>
            <div class="form-group">
              <label class="control-label">Email Address <span>*</span></label>
              <input type="email" name="email" class="form-control white_bg" id="emailaddress" required autocomplete="off">
            </div>
            <div class="form-group">
              <label class="control-label">Phone Number <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumber" required autocomplete="off">
            </div>
            <div class="form-group">
